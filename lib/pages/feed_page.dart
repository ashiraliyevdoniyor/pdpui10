...
import 'package:pdpui10/model/post_model.dart';
import 'package:pdpui10/model/story_model.dart';
    ...
    return Container(
      ...
      child: Column(
        children: [
                ...
                Row(
                  children: <Widget>[
                    ClipRRect(
                      ...
                      child: Image(
                        image: AssetImage("assets/images/feed_1.jpeg"),//post.userImage
                        width: 40,
                        height: 40,
                        fit: BoxFit.cover,
                      ),
          ...
          FadeInImage(
            image: AssetImage("assets/images/user_1.jpeg"),//post.postImage
